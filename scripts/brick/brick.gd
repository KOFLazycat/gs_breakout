...
@export var long_full: CompressedTexture2D = preload("res://assets/images/brick/BlockLongFull.png")
@export var long_border: CompressedTexture2D = preload("res://assets/images/brick/BlockLongBorder.png")
@export var small_full: CompressedTexture2D = preload("res://assets/images/brick/BlockSmallFull.png")
@export var small_border: CompressedTexture2D = preload("res://assets/images/brick/BlockSmallBorder.png")

@export var one: CompressedTexture2D = preload("res://assets/images/brick/One.png")
@export var two: CompressedTexture2D = preload("res://assets/images/brick/Two.png")
@export var three: CompressedTexture2D = preload("res://assets/images/brick/Three.png")
@export var bomb: CompressedTexture2D = preload("res://assets/images/brick/Bomb.png")
@export var energy: CompressedTexture2D = preload("res://assets/images/brick/Energy.png")
